...
import { normalizeAny } from './normalizers/adf';
import { looksLikeChatLead, normalizeChatPlain } from './normalizers/chat';
import { classifyLeadSource } from './ingest/classify';
...
function base64UrlToUtf8(maybeB64Url: string) {
...
export const receiveEmailLead = functions.runWith(FN_OPTS).https.onRequest(async (req, res) => {
